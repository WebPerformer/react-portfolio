    ...
    <>
        ...
        <div className="content">
          <div className="home-content">
            ...
            <div className="home-btn">
              <button className="see-more"><a href="https://www.linkedin.com/in/webperformer/">HIRE ME</a></button>
              <button className="download"><a href="src\assets\images\CV.pdf" download="Gabriel Silva Araujo CV">DOWNLOAD CV</a></button>
            </div>
          </div>
        </div>
        <div className="box">
          ...
          <div className="right">
            ...
            <div className="social">
              ...
              <div className="social-icons">
                <a href="https://www.linkedin.com/in/webperformer/"><FiLinkedin/></a>
                <a href="https://github.com/WebPerformer"><FiGithub/></a>
                <a href="https://api.whatsapp.com/send?phone=5511915657659"><AiOutlineWhatsApp/></a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="content">
          <div className="cards">
            <div className="card" data-aos="fade-up" data-aos-duration="1000">
              ...
              <p>Interface development such as: Web pages, Portfolios, User Interfaces, etc.</p>
        ...
        <div className="content">
          ...
          <div className="resume-container">
            <div className="project">
              <div className="project-title">FREELANCER</div>
          ...
          <div className="resume-container">
            <div className="project">
              <div className="project-title">FRONTEND</div>
          ...
          <a href="https://www.linkedin.com/in/webperformer/"><button>LET'S WORK TOGETHER</button></a>
        </div>
      </section>
      ...
      <section className="project" id="project">
        <div className="content">
          <div className="cards">
            <div className="card" data-aos="fade-up" data-aos-duration="1000">
              <img src={project[0].img} alt="" />
              <h1 className="title">{project[0].name}</h1>
              <p className="category">{project[0].category}</p>
            </div>
            <div className="card" data-aos="fade-up" data-aos-duration="1000">
              <img src={project[1].img} alt="" />
              <h1 className="title">{project[1].name}</h1>
              <p className="category">{project[1].category}</p>
            </div>
            <div className="card" data-aos="fade-up" data-aos-duration="1000">
              <img src={project[2].img} alt="" />
              <h1 className="title">{project[2].name}</h1>
              <p className="category">{project[2].category}</p>
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="contact-info">
              ...
              <div className="contact-container">
                ...
                <div className="infos">
                  ...
                  <div className="info">github.com/WebPerformer</div>
                </div>
              </div>
            </div>
