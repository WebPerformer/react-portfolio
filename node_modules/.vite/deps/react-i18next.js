...
} from "./chunk-LKEGAGZX.js";
import {
  _classCallCheck,
  _createClass
} from "./chunk-DKXWROME.js";
import {
  require_react
} from "./chunk-CEOYSQWH.js";
import {
  __commonJS,
  __toESM
...
function n(n2) {
  ...
  if (i2 && (r2.name = i2[1], (import_void_elements.default[i2[1]] || n2.charAt(n2.length - 2) === "/") && (r2.voidElement = true), r2.name.startsWith("!--"))) {
    var s2 = n2.indexOf("-->");
    return { type: "comment", comment: s2 !== -1 ? n2.slice(4, s2) : "" };
  }
  for (var a2 = new RegExp(t), c2 = null; (c2 = a2.exec(n2)) !== null; )
    if (c2[0].trim())
      if (c2[1]) {
        var o = c2[1].trim(), l = [o, ""];
...
var c = { parse: function(e2, t2) {
  ...
  if (e2.indexOf("<") !== 0) {
    var u = e2.indexOf("<");
    c2.push({ type: "text", content: u === -1 ? e2 : e2.substring(0, u) });
  }
  return e2.replace(r, function(r2, s2) {
    ...
    if (f && (l++, (a2 = n(r2)).type === "tag" && t2.components[a2.name] && (a2.type = "component", m = true), a2.voidElement || m || !d || d === "<" || a2.children.push({ type: "text", content: e2.slice(p, e2.indexOf("<", p)) }), l === 0 && c2.push(a2), (u2 = o[l - 1]) && u2.children.push(a2), o[l] = a2), (!f || a2.voidElement) && (l > -1 && (a2.voidElement || a2.name === r2.slice(2, -1)) && (l--, a2 = l === -1 ? c2 : o[l]), !m && d !== "<" && d)) {
      u2 = l === -1 ? c2 : o[l].children;
      var x = e2.indexOf("<", p), g = e2.slice(p, x === -1 ? void 0 : x);
